      ...
      setTimeout(() => {
        if (window.DruidWebchat_v2) {
          window.DruidWebchat_v2.init({
            botId: "3702e5e3-8f88-4542-59ef-08dce937fd7a",
      ...
      <div className="flex flex-col md:flex-row mt-8 md:mt-12 flex-grow">
        <div className="md:w-1/3 lg:w-1/4 flex flex-col items-center p-4 space-y-8">
          <div className="bg-gray-800 rounded-full shadow-lg border-4 border-green-400">
            <img src="/logo_merlin.webp" alt="Logo" className="h-32 w-32 md:h-40 md:w-40 lg:h-48 lg:w-48 rounded-full"/>
          </div>
        ...
        {/* Bloc Description du bot et Chatbot */}
        <div className="flex flex-col items-center md:w-2/3 lg:w-3/5 max-w-full md:max-w-5xl space-y-4">
          <div className="text-center bg-gray-800 p-4 md:p-6 rounded-t-lg shadow-lg w-full">
            <h1 className="text-2xl md:text-4xl font-extrabold text-green-400 mb-4">
              Bienvenue sur notre chatbot IA spécialisé DruidAI !
            </h1>
